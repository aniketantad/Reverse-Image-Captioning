...
from eval_gancls import GanClsEval
from model import GanCls
from trainer import GanClsTrainer
from visualize_gancls import GanClsVisualizer
...
flags = tf.app.flags
flags.DEFINE_string('cfg', '/share/hipp/Neural_Project/text-to-image-master/gancls/cfg/flowers.yml',
