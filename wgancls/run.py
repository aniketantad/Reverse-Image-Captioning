...
from trainer import WGanClsTrainer
from eval_wgan import WGanClsEval
from visualize_wgan import WGanClsVisualizer
...
flags = tf.app.flags
flags.DEFINE_string('cfg', '/share/hipp/Neural_Project/text-to-image-master/wgancls/cfg/flowers.yml',
